let botoesRobo = document.querySelector('.botoes-robo');

botoesRobo.addEventListener('click', (event) => {
    let roboImg = document.querySelector('.robo')
    roboImg.src = `img/${event.target.textContent}.png`
})
